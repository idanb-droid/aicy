...
export const INJECTION_RULES: InjectionRule[] = [
  ...
  { id: "B-secret-exfil", category: "B", description: "Probe for env vars / API keys", pattern: /(environment variables?|configuration values?|api keys?).{0,60}(print|dump|reveal|as json|beginning with|you can see)/ },
